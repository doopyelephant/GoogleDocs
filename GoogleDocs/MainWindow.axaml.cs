...
public partial class MainWindow : Window
{
    ...
    private TextWriter debugwriter = new StringWriter();
    private TextReader debugreader = new StringReader("");
    private TextWriter defwriter = new StringWriter();
    private TextReader defreader = new StringReader("");
    private void InitializeDebugMenu()
    {
        defwriter = Console.Out;
        defreader = Console.In;
        Console.SetOut(debugwriter);
        Console.SetIn(debugreader);
        ProbeDebugMenu();
    }
    public MainWindow()
    {
    ...
    private async void ProbeDebugMenu()
    {
    ...
    public void PrintLineToDefault(string text)
    {
        defwriter.Write(text + "\n");
    }
...
catch (HttpRequestException err)
{
    ...
    {
        PrintLineToDefault("Printing: " + DebugMenuInput.Text);
        debugwriter.WriteLine(DebugMenuInput.Text);
        ProbeDebugMenu();
    }
}